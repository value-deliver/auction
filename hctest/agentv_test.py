...
async def main():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            test_url = SiteKey.as_site_link(SiteKey.user_easy)  # Easy test challenges
            # Alternative test URLs:
            # test_url = SiteKey.as_site_link(SiteKey.discord)
            # test_url = SiteKey.as_site_link(SiteKey.epic)
